...
function provideHover(document, position, token) {
	...
	let list = [
		...
		{ id: 'disable hud', name: 'Hides and disables the user interface elements including: Resources, hitpoints and ability buttons' },
		{ id: 'enable hud', name: 'Brings back all the user interface elements hidden by a previous "disable hud" command' },
